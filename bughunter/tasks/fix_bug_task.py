"""
Fix Bug Task - Provides a complete patch to fix the identified bug
"""
...
class FixBugTask(BaseTask):
    """Task for fixing bugs and providing patches"""
